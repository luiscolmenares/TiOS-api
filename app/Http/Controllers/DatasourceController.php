        ...
        foreach ($datasources as $datasource) {
            ...
            if (($datasource->left_coordinate != null) && ($datasource->top_coordinate != null) && ($datasource->image != null)){
                ...
                $d = array(
                    ...
                    'options_array' => $options_array,
                    'description' => '<img class="picture" src="'.$url.'/datasources/images/'.$datasource->image.'" alt="'.$datasource->name.'"><p class="description">'.$datasource->type.'</p><p><button id="custombtn" onclick="myFunction()">Click me</button></p>',
                    'position' => $position,
